...
int getprocs(uint, struct uproc*); // ps command
#endif // CS333_P2
#ifdef CS333_P4
int setpriority(int, int); // setting the priority for an active process with PID to priority and resetting the budget to the default value
int getpriority(int);
#endif // CS333_P4
